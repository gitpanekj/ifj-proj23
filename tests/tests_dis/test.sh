...
execTest "Call procedure, try to init" "input/proc_call_init.swift" "output/empty.txt" 8
...
execTest "Comparison of different types" "input/rel_wrong_type.swift" "output/empty.txt" 0
